...
STAGE2_LGBM_CONFIG = {
    ...
    'num_class': 5,              # personal, otp, banking, subscription, recharge_data
...
# HAM categories list (Stage 2 only; "all" is a UI filter, not an ML label)
HAM_CATEGORIES = ['personal', 'otp', 'banking', 'subscription', 'recharge_data']
